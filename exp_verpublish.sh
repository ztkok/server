VERSION_NAME=zt_lastone_Exp_`date +"%Y%m%d-%H%M%S"`
...
sed '/"53": {/{:1;N;/"value":/!b1;s/"value":.*/"value":30,\r/}' -i system.json
sed '/"55": {/{:1;N;/"value":/!b1;s/"value":.*/"value":30,\r/}' -i system.json
sed '/"7": {/{:1;N;/"value":/!b1;s/"value":.*/"value":300,\r/}' -i system.json


#sed '/"1": {/{:1;N;/"rewardVersion":/!b1;s/"rewardVersion":.*/"rewardVersion":"4.0.0"\r/}' -i ReversionWard.json
