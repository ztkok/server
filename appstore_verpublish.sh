VERSION_NAME=zt_lastone_Appstore_`date +"%Y%m%d-%H%M%S"`
...
sed '/"53": {/{:1;N;/"value":/!b1;s/"value":.*/"value":1,\r/}' -i system.json
sed '/"55": {/{:1;N;/"value":/!b1;s/"value":.*/"value":30,\r/}' -i system.json
sed '/"63": {/{:1;N;/"value":/!b1;s/"value":.*/"value":50,\r/}' -i system.json
