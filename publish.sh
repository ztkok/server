...
sed '/"Gateway": {/{:1;N;/"OuterAddr":/!b1;s/"OuterAddr":.*/"OuterAddr":"192.168.150.160",\r/}' -i server.json
sed '/"Lobby": {/{:1;N;/"MySQLAddr":/!b1;s/"MySQLAddr":.*/"MySQLAddr":"192.168.150.160:3306",\r/}' -i server.json
sed '/"Room": {/{:1;N;/"OuterAddr":/!b1;s/"OuterAddr":.*/"OuterAddr":"192.168.150.160",\r/}' -i server.json
sed '/"DataCenter": {/{:1;N;/"OuterAddr":/!b1;s/"OuterAddr":.*/"OuterAddr":"192.168.150.160",\r/}' -i server.json
sed '/"DataCenter": {/{:1;N;/"MySQLAddr":/!b1;s/"MySQLAddr":.*/"MySQLAddr":"192.168.150.160:3306",\r/}' -i server.json
